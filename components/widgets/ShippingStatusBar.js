...
const ShippingStatusBar = ({
  ...
  return <Svg width={animationWidth} height="56" viewBox={`0 0 ${animationWidth} 2`}>
    {/*light yellow circle*/}
    ...
    {phaseNumber === 0 &&
        <View style={{top: 16}}>
          <Svg fill="none">
            ...
            <Path x={17} y={0} d="M9 9H13" stroke="white" strokeLinecap="round"/>
            <Path x={17} y={0} d="M9 12H13" stroke="white" strokeLinecap="round"/>
            <Path x={17} y={0} d="M9 15H13" stroke="white" strokeLinecap="round"/>
          </Svg>
        </View>
    }
